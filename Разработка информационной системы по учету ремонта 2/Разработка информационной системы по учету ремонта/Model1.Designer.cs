// Создание кода T4 для модели "C:\Users\User\source\repos\Разработка информационной системы по учету ремонта\Разработка информационной системы по учету ремонта\Model1.edmx" включено. 
